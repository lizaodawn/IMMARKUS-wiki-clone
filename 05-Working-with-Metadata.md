...
2.  Metadata categories are added in the same way as properties for entity classes with the same [property options](https://github.com/rsimon/immarkus/wiki/03-Designing-Data-Model#property-options).  
