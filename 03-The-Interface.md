After [uploading an image folder](https://github.com/rsimon/immarkus/wiki/04-Uploading-Images), the IMMARKUS interface appears. The following options are available in the left menu bar:
