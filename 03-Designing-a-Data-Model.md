...
8.	Add/edit the properties. Click the drop down menu next to **No Properties** (circled in blue in **Figure 5**)
...
**Figure 5.** Creating Properties in the Data Model Mode

9.	Click **Add Property**. This opens the property editor as shown in **Figure 6**.
...
**Figure 6.** Adding Properties in Data Model Mode
...
**Figure 7.** Selecting a Data Type in the Data Model Mode
...
**Figure 8.** Creating Parent-Child Relationships
<br/><br/>
...
The entity classes for which you have created child classes have a drop-down menu (“>”) on the left (red square in **Figure 10**). 
...
* In the row of the child class, you can only see the properties that have been specifically added to the child class (see the properties for "location site" parent and "survey area" child in **Figure 10**). 
